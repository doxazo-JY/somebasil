...
export default function EditStaffModal({ staff, onClose }: EditStaffModalProps) {
  ...
  const [form, setForm] = useState({
    ...
    hourly_pay: String(staff.hourly_pay),
    sunday_hourly_pay: staff.sunday_hourly_pay ? String(staff.sunday_hourly_pay) : '',
    tax_rate: String(staff.tax_rate),
    is_active: staff.is_active,
  })
  const [useCustomTax, setUseCustomTax] = useState(staff.tax_rate !== 3.3)
    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl w-full max-w-sm mx-4 shadow-xl">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <p className="font-semibold text-gray-800">직원 정보 수정</p>
        ...
        <form onSubmit={handleSubmit} className="px-6 py-5 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                type="date" value={form.leave_date}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <div className="relative">
                <input
                  type="number" required value={form.hourly_pay}
                  onChange={(e) => set('hourly_pay', e.target.value)}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  type="number" value={form.sunday_hourly_pay}
                  onChange={(e) => set('sunday_hourly_pay', e.target.value)}
          ...
          <div>
            ...
            {useCustomTax && (
              <div className="relative mt-2">
                <input
                  type="number" step="0.1" value={form.tax_rate}
