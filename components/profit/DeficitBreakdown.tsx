...
export default function DeficitBreakdown({
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 px-5 py-5">
      <p className="text-sm font-semibold text-gray-700 mb-4">{periodLabel} 비용 구조</p>
      ...
      <div className="flex flex-col gap-3">
        {items.map(({ key, amount }) => {
          ...
          const pctOfExpense = totalExpense > 0 ? (amount / totalExpense) * 100 : 0
      ...
      {totalExpense > income && (
        <div className="mt-2 flex items-center justify-between text-sm">
          <span className="text-red-400">{periodLabel} 적자</span>
